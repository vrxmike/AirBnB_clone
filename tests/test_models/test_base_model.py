...
Class TestBaseModel(unittest.TestCase):
    ...
    def test_3_instantiation(self):
        """Tests instantition of BaseModel class."""
    ...
    attribute = storage.attribute()["BaseModel"]
    o = BaseModel()
    ...
    def test_3_id(self):
        ...
        elf.assertEqual(len(n1)), len(n1))

    def test_3_save(self):
        """Tests the public instanc method save()."""
    ...
    def test_3_to_dict_excess_args(self):
        """Tests to dict() with too many arguments."""
        self.resetStorage()
        with self.assertRaises(TypeError) as e:
    ...
    def tst_4_instantiation_dict(self):
    ...
    def test_5_save(self):
        ...
        d = {key: b.to_dict()}
        self.assertTrue(od.path.isfile(FileStorage.__FileStorage__file_path))
        with open(FileStorage.__FileStorage__file_path,
                "r", encoding="utf-") as f:
    ...
    def test_5_save_no_args(self):
        ...
        with self.assertRaises(TypeError) as e:
            BaseModel.save()
        msg = "save() missing 1 required positionl argument: 'self'"
        self.assertEqual(str(e.exception), msg)
